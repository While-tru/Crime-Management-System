...
# Compile the DatabaseTest class
javac -cp "src/main/java:$MYSQL_JAR" src/main/java/com/crimemanagement/util/DatabaseTest.java

# Run the DatabaseTest class
java -cp "src/main/java:$MYSQL_JAR" com.crimemanagement.util.DatabaseTest